 ...
 */
public class ConfeagerPropertyEnum<T extends Enum<T>> extends ConfeagerPropertyEnumOf<T> {

    public ConfeagerPropertyEnum(String key, Class<T> tClass) {
        super(key, tClass);
    }

    public ConfeagerPropertyEnum(String key, Class<T> tClass, T defaultValue) {
